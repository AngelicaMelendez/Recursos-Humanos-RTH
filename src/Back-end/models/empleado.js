...
module.exports = (sequelize, DataTypes) => {
  const Empleado = sequelize.define('Empleado', {
    ...
    correo_electronico: { type: DataTypes.STRING, allowNull: true },
    ...
    No_de_empleado: { type: DataTypes.STRING, allowNull: true },
    nivel: { type: DataTypes.STRING, allowNull: true },
    nss: { type: DataTypes.STRING, allowNull: true },
    numero_imss: { type: DataTypes.STRING, allowNull: true },
    numero_afiliacion_isste: { type: DataTypes.STRING, allowNull: true },
    unidad_medica_asignada: { type: DataTypes.STRING, allowNull: true },
    num_poliza_seguro_vida: { type: DataTypes.STRING, allowNull: true },
    num_poliza_seguro_gastos_medicos: { type: DataTypes.STRING, allowNull: true },
    ...
    horario_laboral: {
      type: DataTypes.ENUM('FIJO','NO-FIJO'), 
      allowNull: true,
      defaultValue: 'FIJO'
    },
    ...
    discapacidad_o_condicion_especial: { type: DataTypes.STRING, allowNull: true },
    medicamentos_necesarios: { type: DataTypes.STRING, allowNull: true },
    ...
    contacto_telefono_alternativo: { type: DataTypes.STRING, allowNull: true },
    contacto_direccion: { type: DataTypes.STRING, allowNull: true },
